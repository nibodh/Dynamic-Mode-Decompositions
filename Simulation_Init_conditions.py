...
def Glycoscillator():
    IC_train = [ 0.5325, 0.4767, 0.0618, 0.3173, 0.2075, 1.5311, 0.0572] #This IC grows onto the limit cycle, away from an unstable fp
...
#     IC_1 = [ 0.875, 1.175, 0.12, 0.225, 0.19, 1.405, 0.075] #Artbitrarily selected IC
    ...
    IC = np.transpose([IC_train, IC_test])
    return IC

def Repressilator():
    IC_train = [3.79156715, 5.65839438, 4.45129228, 3.87443063, 5.07860964, 4.89017854] #This IC grows onto the limit cycle, away from an unstable fp
